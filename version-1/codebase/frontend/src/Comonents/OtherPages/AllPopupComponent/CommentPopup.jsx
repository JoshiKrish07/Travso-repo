...
import { commentOnPost, getCommentOnPost, likeAnyComment, LikeUnlikePost } from "../../../redux/slices/postSlice";
...
//  console.log("===showEmojiPicker==>", showEmojiPicker);
 ...
 // to show post images
 const mediaArray = allPosts && allPosts[0].media_url.replace(/^\[\"|\"?\]$/g, '').split('","'); // Split the string into individual URLs
        ...
        <div className="flex flex-1 overflow-hidden">
          ...
          <div className="w-3/5 px-6 py-4 flex flex-col justify-between">
            ...
            <div className="flex items-center justify-between space-x-4 mb-1 pb-2 ">
              <div className="flex items-center gap-2">
                <img
                  src={allPosts && allPosts[0]?.profile_image || dummyUserImage}
                  alt="Avatar"
            ...
            <div className="flex-1 overflow-y-auto scrollbar-hidden">
              <div className="relative w-full max-w-4xl mx-auto">
                ...
                <div className="flex justify-center mt-1">
                  {mediaArray && mediaArray?.map((_, index) => (
                    <div
                      key={index}
          ...
          <div className="w-2/5 px-6 py-4 h-full border-l border-gray-100 flex flex-col justify-between">
            ...
            <div className="flex-1 overflow-y-auto scrollbar-thin space-y-4">
              {/* <div className="mt-6"> */}
                { postComment && postComment.map((userPosts, index) => {
                  return (
                    <div className="mt-6" key={index}>
                    {/* Parent Comment Reaction */}
                    <div className="flex items-start space-x-3 rounded-md">
                      {/* Profile Image */}
                      <img src={userPosts?.profile_image || dummyUserImage} alt="User" className="w-8 h-8 rounded-full" />
                      ...
                      <div className="w-full flex flex-col space-y-2">
                        ...
                        <div className="-mt-5 flex items-center gap-2">
                          <div className="flex items-center">
                            <div className="flex items-center cursor-pointer" onClick={() => handleCommentLikeUnlike(userPosts.id)}>
                              <img
                                src={noto_fire}
                                alt="noto_fire"
                                className="w-4 h-4"
                      ...
                      {
                        userPosts.comment_reply && userPosts.comment_reply.map((userReply, replyIndex) => {
                          return (
                            <div key={replyIndex}>
            ...
            <div className="mt-3">
              <div className="flex items-center gap-2">
                {/* Profile Image */}
                <img
                  src={userDetails && userDetails.profile_image || dummyUserImage}
                  alt="Profile"
